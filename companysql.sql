...
create table project(
  ...
  RENAME TABLE dept_lotacions TO dept_locations;
-- 'def', 'company_constraints', 'dept_locations_ibfk_1', 'company_constraints', 'dept_locations', 'FOREIGN KEY', 'YES'
...
-- Exemplo de código SQL para remover uma foreign key
ALTER TABLE dependent DROP FOREIGN KEY fk_dependent;

ALTER TABLE department
DROP CONSTRAINT chk_date_dept;


  
desc employee;
select * from information_schema.table_constraints
  where constraint_schema = 'company_cdependentonstraints';
